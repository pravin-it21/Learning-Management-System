...
@ControllerAdvice
public class ProgressTrackingGlobalExceptionHandler {
	...
	@ExceptionHandler(value = ProgressTrackingNotFound.class)
	public ResponseEntity<ExceptionResponse> handleAdminRegistrationException(ProgressTrackingNotFound exception,
